                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="{{ $servicioId ? 'update' : 'create' }}">
                            <div class="mb-4">
                                ...
                                <input type="text" wire:model="placa" id="placa"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" wire:model="certificador" id="certificador"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                                    placeholder="certificador" required>
                                @error('certificador')
                                    <div class="text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" wire:model="taller" id="taller"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" wire:model="precio" id="precio"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                            ...
                            <div class="card-footer text-center">
                                ...
                                <button wire:click="resetForm" type="button"
                                    class="bg-gray-300 text-gray-600 py-2 px-4 rounded-md shadow-md ml-2">
                                    Cancelar
                                </button>
                            </div>
                        </form>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-indigo-500 text-white">
                        ...
                        <button type="button" class="bg-red-500 text-white py-1 px-2 rounded" data-dismiss="modal"
                            aria-label="Close" wire:click="closeViewModal">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="mb-4">
                                <label for="placa" class="block">Placa:</label>
                                <input type="text" value="{{ $modalData['placa'] }}" id="placa"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                                    readonly>
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="serie" class="block">Serie:</label>
                                <input type="text" value="{{ $modalData['serie'] }}" id="serie"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                                    readonly>
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="certificador" class="block">Certificador:</label>
                                <input type="text" value="{{ $modalData['certificador'] }}" id="certificador"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                                    readonly>
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="taller" class="block">Taller:</label>
                                <input type="text" value="{{ $modalData['taller'] }}" id="taller"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                                    readonly>
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="precio" class="block">Precio:</label>
                                <input type="number" value="{{ $modalData['precio'] }}" id="precio"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                                    readonly>
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="fecha" class="block">Fecha:</label>
                                <input type="date" value="{{ $modalData['fecha'] }}" id="fecha"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                                    readonly>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ $modalData['tipoServicio'] }}" id="tipoServicio"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                                    readonly>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ $modalData['estado'] }}" id="estado"
                                    class="form-control border border-purple-500 focus:border-purple-700 rounded-md shadow-md"
                                    readonly>
                            </div>
